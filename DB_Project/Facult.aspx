    ...
    <div class="row">
            <div class="col-md-4 offset-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Muneer Elahi</h5>
                        <p class="card-text">Department of Computer Science</p>
                        <p class="card-text">FAST - NUCES</p>
                        <p class="card-text">Email: MuneerElahi@nu.edu.pk</p>
                        <p class="card-text">Phone: 0309-6543532</p>
                    </div>
                </div>
            </div>
        </div>
