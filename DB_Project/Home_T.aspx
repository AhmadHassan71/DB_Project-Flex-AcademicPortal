<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Home_T.aspx.cs" Inherits="_Default" %>
...
<body>
    ...
    <form id="form1" runat="server">
		...
		<div class="logo">
			...
			<div class="signup" >
				<a href="Facult.aspx">Login</a>
				</div>

		<div class="signup">
			<p>Don't have an account? Use ARN to <a href="signup_T.aspx">Sign up</a></p>
			</div>
</div>
		</form>
